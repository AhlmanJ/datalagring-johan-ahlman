...
namespace EducationPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260211134608_AddedNewPropertyToParticipantsEntity")]
    partial class AddedNewPropertyToParticipantsEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EducationPlatform.Domain.Entities.InstructorsEntity", b =>
                {
                    ...
                    b.HasIndex(new[] { "Email" }, "UQ_InstructorsEntity_Email")
                        .IsUnique();

                    b.ToTable("Instructors", null, t =>
                        {
                            t.HasCheckConstraint("CK_Instructors_Email_NotEmpty", "LTRIM(RTRIM([Email])) <> ''");
                        });
                });
